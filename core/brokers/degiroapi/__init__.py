...
class DeGiro:
    ...
    __LOGIN_2WAY_URL = 'https://trader.degiro.nl/login/secure/login/totp'
    ...
    def login(self, username, password, twoWay=""):
        login_payload = {
            'username': username,
            'password': password,
        ...
        if(len(twoWay) > 0):
            login_payload["oneTimePassword"] = twoWay
            login_response = self.__request(DeGiro.__LOGIN_2WAY_URL, None, login_payload, request_type=DeGiro.__POST_REQUEST,
